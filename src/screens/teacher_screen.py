...
from src.components.dialoge import create_subject_dialoge
from src.components.subject_card import subject_card
from src.components.dialoge_share_subject import share_subject_dialog
from src.components.dialog_add_photo import add_photo_dialoge
from src.database.config import supabase
from src.pipelines.face import predict_attendance
from src.components.dialoge_show_aatendance import attendance_result_dialog
from src.components.dialoge_voice_attendance import voice_attendance_dialog
def teacher_screen():
...
def teacher_dashboard():
    ...
    with tab3:
        ...
        if st.button("attendance record", type=type3 ,width="stretch"):
...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning("you havent create any subjects yet!")
        return
    ...
    with col2:
        if st.button("add photo" , type="primary" , icon=":material/photo_prints:" , width="stretch"):
            add_photo_dialoge()
    ...
    if st.session_state.attendance_images:
        ...
        with c1:
            if st.button("clear photos", width="stretch"):
                st.session_state.attendance_images = []
                st.rerun()
...
def teacher_tab_manage_subject():
    ...
    with col1:
        st.subheader("manage subject" , width="stretch")
    with col2:
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("enter your username" , placeholder="@aditya")
    teacher_pass = st.text_input("Enter the password" , type="password" , placeholder="enter the password")
    st.space()
    ...
    with btn2:
        if st.button("Ragister" , type="primary" ,icon=":material/passkey:" , width="stretch"):
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("enter your username" , placeholder="@aditya")
    teacher_name = st.text_input("enter your name" , placeholder="aditya naikawadi")
    teacher_pass = st.text_input("Enter the password" , type="password" , placeholder="enter the password")
    teacher_pass_confirm= st.text_input("confirm your password" , type="password" , placeholder="enter the password")
    st.space()
    btn1, btn2 = st.columns(2)
